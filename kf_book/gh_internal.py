...
def plot_estimate_chart_2():
    with figsize(y=2.5):
        ...
        plt.text (0.0, 159.8, r"last estimate ($\hat{x}_{t-1}$)", ha='left', va='top',fontsize=18)
        plt.xlabel('day')
        plt.ylabel('weight (lbs)')
        ax.xaxis.grid(True, which="major", linestyle='dotted')
        ax.yaxis.grid(True, which="major", linestyle='dotted')
...
def plot_estimate_chart_3():
    with figsize(y=2.5):
        ...
        plt.text (0, 159.8, r"last estimate ($\hat{x}_{t-1}$)", ha='left', va='top',fontsize=18)
        plt.text (0.95, est_y, r"estimate ($\hat{x}_{t}$)", ha='right', va='center',fontsize=18)
        plt.xlabel('day')
        plt.ylabel('weight (lbs)')
        ax.xaxis.grid(True, which="major", linestyle='dotted')
        ax.yaxis.grid(True, which="major", linestyle='dotted')
